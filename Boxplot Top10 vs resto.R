...
library(modeest)
means_TOP1 <- apply(features_avg_pos[features_avg_pos$top == "Top 1",c(4:11)], 2, mean)
means_TOP10 <- apply(features_avg_pos[features_avg_pos$top == "Top 2-10",c(4:11)], 2, mean)
means_TOP200 <- apply(features_avg_pos[features_avg_pos$top == "Top 11-200",c(4:11)], 2, mean)
medians_TOP1 <- apply(features_avg_pos[features_avg_pos$top == "Top 1",c(4:11)], 2, median)
medians_TOP10 <- apply(features_avg_pos[features_avg_pos$top == "Top 2-10",c(4:11)], 2, median)
medians_TOP200 <- apply(features_avg_pos[features_avg_pos$top == "Top 11-200",c(4:11)], 2, median)
sd_TOP1 <- apply(features_avg_pos[features_avg_pos$top == "Top 1",c(4:11)], 2, sd)
sd_TOP10 <- apply(features_avg_pos[features_avg_pos$top == "Top 2-10",c(4:11)], 2, sd)
sd_TOP200 <- apply(features_avg_pos[features_avg_pos$top == "Top 11-200",c(4:11)], 2, sd)

medidas_tendencia_central_porposicion <- data.frame(cbind(means_TOP1, means_TOP10, means_TOP200, medians_TOP1, medians_TOP10, medians_TOP200, sd_TOP1, sd_TOP10, sd_TOP200))
names(medidas_tendencia_central_porposicion) <- c("Promedio Top 1", "Promedio Top 2-10", "Promedio Top 11-200", "Mediana Top 1", "Mediana Top 2-10", "Mediana 11-200", "Des. Std. Top 1", "Des. Std. Top 2-10", "Des. Std. 11-200")
rownames(medidas_tendencia_central_porposicion) <- c("Danceability", "Energy", "Loudness", "Speechiness", "Acousticnes", "Instrumentalness", "Liveness", "Valence")
